...
public class CustomerController {
     ...
     */
        @PostMapping("/new")
        public ResponseEntity<String> createCustomerAccount(@RequestBody Customer incomingCustomer) {
            ...
            if (success ==true) {
                ...
                return ResponseEntity.badRequest().body("Error in creating new Customer Account");
            }
        }
